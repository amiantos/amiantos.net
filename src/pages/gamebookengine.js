      ...
      <PostContainer>
        <Post>
          ...
          <Content>
            ...
            <p>
              Gamebook Engine does not collect any information about you or your
              usage of the app, beyond anonymous statistics that you allow to be
              sent to Apple via a setting on your device. Any content you create
              with Gamebook Engine is entirely your property and does not belong
              to Gamebook Engine or its creators in any way. If you share
              Gamebooks using the export function, who you share them with is
              your responsibility.
            </p>
          </Content>
        </Post>
